...
public class CityRest {
	...
	@ApiOperation("Search top 5 city")
	@GetMapping("/startDate/{start}/endDate/{end}")
	public List<CityVo> findTopfiveCity(@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date start,
										@PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date end) {
    	return cityService.findTopfiveCity(start,end);
	}
